...
namespace SurveyBasket.API.Core.Migrations
{
    ...
    [Migration("20241023105311_AddAuditTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurveyBasket.API.Models.Poll", b =>
                {
                    b.HasOne("SurveyBasket.API.Entities.ApplicationUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SurveyBasket.API.Entities.ApplicationUser", "UpatedByUser")
                        .WithMany()
                        .HasForeignKey("UpdatedByUserId");

                    b.Navigation("CreatedByUser");

                    b.Navigation("UpatedByUser");
                });
